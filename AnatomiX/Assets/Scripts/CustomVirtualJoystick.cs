...
public class CustomVirtualJoystick : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IDragHandler
{
    ...
    public delegate void JoystickMoved(Vector2 input);
    ...
    protected virtual void Awake()
    {
        ...
        Debug.Log("Joystick initialized. Type: " + joystickType);
    }
    ...
    public void OnPointerDown(PointerEventData eventData)
    {
        ...
        Debug.Log("Handle position: " + handle.anchoredPosition);
    }
    ...
    public void OnDrag(PointerEventData eventData)
    {
        ...
        joystickInput = handle.anchoredPosition / movementRange;
        OnJoystickMoved?.Invoke(joystickInput);
    ...
    protected Vector2 GetAnchoredPosition(Vector2 screenPosition)
    {
        ...
        if (RectTransformUtility.ScreenPointToLocalPointInRectangle(baseRect, screenPosition, cam, out localPoint))
        {
            ...
            Vector2 anchoredPosition = localPoint - (centerArea.anchorMax * baseRect.sizeDelta) + pivotOffset;
            Debug.Log("Anchored Position: " + anchoredPosition);
            return anchoredPosition;
        }

        Debug.Log("Anchored Position: (0, 0)");
        return Vector2.zero;
    }
}
